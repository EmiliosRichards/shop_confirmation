...
def generate_exclusion_detection_report(
    ...
    """
    Generates a simple Excel report for the exclusion detection pipeline.
    ...
    """
    try:
        profile = app_config.CLASSIFICATION_PROFILES.get("exclusion_detection", {})
        output_filename = profile.get("output_filename_template", "Exclusion_Detection_Report_{run_id}.xlsx").format(run_id=run_id)
